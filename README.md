...
The *`getData`* functions have the following mutual arguments :
...
format. The *`prepareData`* functions enable to import these data as
ready-to-use `raster` objects, eventually pre-processing them if
relevant (e.g. projection, flipping).
