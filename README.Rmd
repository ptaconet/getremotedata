...
Have a look at the vignette [Efficient extraction of spatial-temporal series over small-scale areas](https://www.nasa.gov/mission_pages/GPM/main/index.html) to check what else you can do using getRemoteData !
