...
Data downloaded through the *`getData`* functions are usually in NetCDF format. The *`prepareData`* functions enable to import these data as ready-to-use `raster` objects, eventually pre-processing them if relevant (e.g. projection, flipping).
