...
- **efficient** because it enables to subset the data to download (spatially/temporally/dimensionnally) at the downloading phase 
- **sustainable** because it uses open and standard data access protocols to download the data
