...
Finally, getRemoteData relies as much as possible on open and standard data access protocols (eg. OPeNDAP), which makes it (and by extension, your script) less vulnerable to external changes than packages or applications relying on APIs.
