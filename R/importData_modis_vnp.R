#' @name importData_modis_vnp
#' @aliases importData_modis_vnp
...
#'
#' rast_modis<-importData_modis_vnp(path_to_raw_modis=path_to_modis,
#' var_name="LST_Day_1km")
#' #plot(rast_modis)
#'

# To open a MODIS dataset that was downloaded via OpenDap
importData_modis_vnp<-function(path_to_raw_modis,var_name){
  grid_nc<-raster::raster(path_to_raw_modis,varname=var_name)
